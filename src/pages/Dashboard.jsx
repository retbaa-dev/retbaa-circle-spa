...
// ─── ACTUALITÉS ──────────────────────────────────────────────
const news = [
  { tag: 'Marché Luxe', date: '16 Mar 2026', title: "Marché luxe MEA : 21,85 Mds$ en 2026, cap sur 36 Mds$ d'ici 2031", summary: "Le marché des produits de luxe au Moyen-Orient et en Afrique progresse à un CAGR de 10,57%, porté par une clientèle premium croissante en Afrique subsaharienne et dans le Golfe. Une trajectoire de croissance structurelle qui valide le positionnement Africa-to-World de Retbaa.", img: '/retbaa-photos/retbaa_11.jpg' },
  { tag: 'Stratégie', date: '5 Mai 2026', title: "LVMH cede des actifs, le luxe independant africain saisit sa chance", summary: "Face au ralentissement du marche occidental, LVMH amorce un virage strategique en se recentrant sur ses marques les plus rentables. Cette recomposition ouvre une fenetre historique pour les maisons independantes africaines comme Retbaa, positionnees sur l'authenticite et l'artisanat.", img: '/retbaa-photos/retbaa_12.jpg' },
  { tag: 'Opportunité', date: '18 Mai 2026', title: "Mode africaine : du patrimoine culturel au luxe international", summary: "La mode et le luxe africains vivent une transformation profonde en 2026 : authenticite, savoir-faire artisanal et storytelling heritage deviennent les nouveaux criteres du luxe global. Les marques africaines s'imposent sur la scene internationale, ouvrant la voie aux maisons comme Retbaa.", img: '/retbaa-photos/retbaa_13.jpg' },
]
