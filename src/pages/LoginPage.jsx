            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  color: '#1A1C1C', letterSpacing: '0.03em',
                  cursor: 'pointer', transition: 'all 0.2s ease',
                }}
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#EFC0D4'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(239,192,212,0.25)' }}
                onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(196,198,208,0.5)'; e.currentTarget.style.boxShadow = 'none' }}
              >
