...
const allDocs = [
  {
    ...
    status: 'sign',
    priority: true,
    pdf: '/docs/governance/pacte-actionnaires.pdf',
  },
  {
    id: 2,
    title: 'Statuts post-augmentation',
    type: 'Corporate',
    format: 'PDF',
    date: 'Fév. 2026',
    size: '0,9 Mo',
    status: 'sign',
    priority: true,
    pdf: '/docs/governance/statuts.pdf',
  },
  {
    id: 3,
    title: 'Registre des titres',
    type: 'Registres',
    format: 'PDF',
    date: 'Fév. 2026',
    size: '0,9 Mo',
    status: 'sign',
    pdf: '/docs/governance/registre-titres.pdf',
  },
  {
    id: 4,
    ...
    size: '0,6 Mo',
    status: 'sign',
    pdf: '/docs/governance/bulletin-souscription.pdf',
  },
  {
    id: 5,
    title: 'Décision du Président',
    type: 'Corporate',
    format: 'PDF',
    date: 'Fév. 2026',
    size: '0,4 Mo',
    status: 'sign',
    pdf: '/docs/governance/decision-president.pdf',
  },
  {
    id: 6,
